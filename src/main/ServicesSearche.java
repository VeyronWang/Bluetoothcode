...
public class ServicesSearche {
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        UUID serviceUUID = new UUID (0x1105);//OBEX_OBJECT_PUSH;
        ...
        for(Enumeration en = RemoteDeviceDiscovery.devicesDiscovered.elements(); en.hasMoreElements(); ) {
            ...
            synchronized(serviceSearchCompletedEvent) {
                ...
                System.out.println(LocalDevice.getLocalDevice().getDiscoveryAgent().searchServices(attrIDs, searchUuidSet, btDevice, listener));
